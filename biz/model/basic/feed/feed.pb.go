...
type FeedResponse struct {
	...
	VideoList      []*common.Video        `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"`                // List of videos.
	NextTime       int64                  `protobuf:"varint,3,opt,name=next_time,json=nextTime,proto3" json:"next_time,omitempty"`                  //The earliest submission time among the videos return this time, used as 'latest_time' for the next requests.
}
...
func (x *FeedResponse) GetCommonResponse() *common.CommonResponse {
	if x != nil {
...
var file_feed_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x44, 0x0a, 0x0b, 0x46,
	...
	0x6e, 0x22, 0x8c, 0x01, 0x0a, 0x0c, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x0a,
	...
	0x32, 0x4f, 0x0a, 0x0b, 0x46, 0x65, 0x65, 0x64, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12,
	0x40, 0x0a, 0x04, 0x46, 0x65, 0x65, 0x64, 0x12, 0x11, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x46,
	0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x66, 0x65, 0x65,
	0x64, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x11,
	0xca, 0xc1, 0x18, 0x0d, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x66, 0x65, 0x65, 0x64,
	0x2f, 0x42, 0x0c, 0x5a, 0x0a, 0x62, 0x61, 0x73, 0x69, 0x63, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x62,
...
var file_feed_proto_goTypes = []interface{}{
	...
	(*common.CommonResponse)(nil), // 2: CommonResponse
	(*common.Video)(nil),          // 3: Video
}
var file_feed_proto_depIdxs = []int32{
	2, // 0: feed.FeedResponse.common_response:type_name -> CommonResponse
	3, // 1: feed.FeedResponse.video_list:type_name -> Video
	0, // 2: feed.FeedHandler.Feed:input_type -> feed.FeedRequest
	1, // 3: feed.FeedHandler.Feed:output_type -> feed.FeedResponse
