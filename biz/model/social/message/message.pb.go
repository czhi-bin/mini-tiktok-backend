...
type MessageChatRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`       // ID of the other user
	PreMsgTime int64  `protobuf:"varint,3,opt,name=pre_msg_time,json=preMsgTime,proto3" json:"pre_msg_time,omitempty"` // Timestamp of the latest previous message
}
...
type MessageChatResponse struct {
	...
	MessageList    []*Message             `protobuf:"bytes,2,rep,name=message_list,json=messageList,proto3" json:"message_list,omitempty"`          // List of messages
}
...
func (x *MessageChatResponse) GetCommonResponse() *common.CommonResponse {
	if x != nil {
...
type MessageActionRequest struct {
	...
	Token      string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`                              // User authentication token
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`     // ID of the other user
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"` // 1 - Send message
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty"`                          // Message content
}
...
func (x *MessageActionResponse) GetCommonResponse() *common.CommonResponse {
	if x != nil {
		return x.CommonResponse
	}
	return nil
...
var file_message_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x6a, 0x0a, 0x12, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74,
	...
	0x03, 0x52, 0x0a, 0x70, 0x72, 0x65, 0x4d, 0x73, 0x67, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x84, 0x01,
	0x0a, 0x13, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x73,
	...
	0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x14,
	...
	0x65, 0x6e, 0x74, 0x22, 0x51, 0x0a, 0x15, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x0f,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe2, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x63, 0x0a, 0x0b, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x12, 0x1b, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61,
	...
	0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x2f, 0x12, 0x6b,
	0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x1d, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x61, 0x67, 0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x42, 0x10, 0x5a, 0x0e, 0x73,
	0x6f, 0x63, 0x69, 0x61, 0x6c, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x62, 0x06, 0x70,
...
var file_message_proto_depIdxs = []int32{
	5, // 0: message.MessageChatResponse.common_response:type_name -> CommonResponse
	2, // 1: message.MessageChatResponse.message_list:type_name -> message.Message
	5, // 2: message.MessageActionResponse.common_response:type_name -> CommonResponse
	0, // 3: message.MessageHandler.MessageChat:input_type -> message.MessageChatRequest
	3, // 4: message.MessageHandler.MessageAction:input_type -> message.MessageActionRequest
	1, // 5: message.MessageHandler.MessageChat:output_type -> message.MessageChatResponse
	4, // 6: message.MessageHandler.MessageAction:output_type -> message.MessageActionResponse
