...
type FavoriteActionRequest struct {
	...
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty"` // 1 - Like, 2 - Unlike
}
...
func (x *FavoriteActionResponse) GetCommonResponse() *common.CommonResponse {
	if x != nil {
...
func (x *FavoriteListRequest) GetUserAuth() *common.UserAuth {
	if x != nil {
		return x.UserAuth
	}
	return nil
...
type FavoriteListResponse struct {
	...
	CommonResponse *common.CommonResponse `protobuf:"bytes,1,opt,name=common_response,json=commonResponse,proto3" json:"common_response,omitempty"` // Includes status code and status description
	VideoList      []*common.Video        `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"`                // List of videos liked by the user
}
...
func (x *FavoriteListResponse) GetCommonResponse() *common.CommonResponse {
	if x != nil {
		return x.CommonResponse
	}
	return nil
...
func (x *FavoriteListResponse) GetVideoList() []*common.Video {
	if x != nil {
		return x.VideoList
	}
	return nil
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x69, 0x0a, 0x15, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x41,
	...
	0x28, 0x05, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x52,
	...
	0x73, 0x65, 0x22, 0x3d, 0x0a, 0x13, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x09, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x55,
	0x73, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x41, 0x75, 0x74,
	0x68, 0x22, 0x77, 0x0a, 0x14, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x0f, 0x63, 0x6f, 0x6d,
	...
	0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x0a, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52,
	0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xef, 0x01, 0x0a, 0x0f, 0x46,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x71,
	...
	0x2f, 0x12, 0x69, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73,
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x13, 0x5a, 0x11,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74,
...
var file_favorite_proto_depIdxs = []int32{
	4, // 0: favorite.FavoriteActionResponse.common_response:type_name -> CommonResponse
	5, // 1: favorite.FavoriteListRequest.user_auth:type_name -> UserAuth
	4, // 2: favorite.FavoriteListResponse.common_response:type_name -> CommonResponse
	6, // 3: favorite.FavoriteListResponse.video_list:type_name -> Video
	0, // 4: favorite.FavoriteHandler.FavoriteAction:input_type -> favorite.FavoriteActionRequest
	2, // 5: favorite.FavoriteHandler.FavoriteList:input_type -> favorite.FavoriteListRequest
	1, // 6: favorite.FavoriteHandler.FavoriteAction:output_type -> favorite.FavoriteActionResponse
	3, // 7: favorite.FavoriteHandler.FavoriteList:output_type -> favorite.FavoriteListResponse
